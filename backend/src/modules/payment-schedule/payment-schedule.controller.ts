...
import { PaymentScheduleFilterDto } from './dto/payment-schedule-filter.dto';
...
export class PaymentScheduleController {
  ...
  @Get()
  async findAll(@Query() filters: PaymentScheduleFilterDto) {
    return this.paymentScheduleService.findAll(filters.projectId, filters.page, filters.limit);
  }
