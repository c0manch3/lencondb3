...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-brown-900 px-4 relative overflow-hidden">
      {/* ASCII art background — subtle layer behind login card */}
      <AsciiBackground opacity={0.08} color="#f9f0d9" />
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-cream-50 rounded-[0.4rem] shadow-xl p-8 border border-brown-200">
          <div className="text-center mb-8">
            ...
            <p className="text-brown-600 mt-2">{t('auth.loginSubtitle')}</p>
          </div>
